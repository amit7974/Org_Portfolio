...
<h1 className='font-semibold text-x1 cursor-pointer'>Ami<><span className='text-green-500 text-2x1'>t</span></>
...
<div onClick={() => setMenu(!menu)} className="md:hidden">
    ...
    <ul className='md:hidden flex flex-col h-screen items-center justify-center space-y-4 text-x-1'>
